...
public class TreeCodStat {
  ...
  /**
   * Pulisce i totali di tutti i nodi della tree dei CodStat. Serve per
   * ricalcolare i totali dopo aver modificato i movimenti.
   */
  ...
  /**
   * Restituisce la lista dei nodi della tree che hanno (anche in parte) la
   * descrizione uguale a quella passata come parametro.
   * 
   * @param p_descr
   *          Descrizione statistica da cercare
   * @return La lista dei nodi della tree che hanno la descrizion statistica a
